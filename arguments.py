...
parser.add_argument('--use_HBV',            action='store_true')
...
parser.add_argument('--highfield',          action='store_false', dest='lowfield')
parser.set_defaults(lowfield      = True)
parser.set_defaults(use_T2W       = False)
parser.set_defaults(use_HBV       = False)
